    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 mb-3">
          ...
          <p className="text-xs sm:text-sm font-extrabold uppercase tracking-[0.15em] text-orange-600">Customer inquiries</p>
        </div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900">Inquiries Dashboard</h1>
      ...
      <section className="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-200/50">
        <div className="border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white px-6 py-5">
          <div className="flex items-center gap-3">
            <span className="text-2xl">📋</span>
            <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900">All Inquiries</h2>
        ...
        {isLoading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-3 text-slate-600">Loading inquiries...</p>
          </div>
        ) : inquiries.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <table className="w-full">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-extrabold uppercase tracking-wider text-slate-600">Company</th>
                  <th className="px-6 py-4 text-left text-xs font-extrabold uppercase tracking-wider text-slate-600">Material</th>
                  <th className="px-6 py-4 text-left text-xs font-extrabold uppercase tracking-wider text-slate-600">Component</th>
                  <th className="px-6 py-4 text-left text-xs font-extrabold uppercase tracking-wider text-slate-600">Urgency</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {inquiries.map((inquiry) => (
                  <tr key={inquiry._id} className="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-white transition-all duration-300">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <button
                          ...
                          className="rounded-xl border-2 border-blue-200 px-4 py-2 text-xs font-extrabold text-blue-700 hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 hover:scale-105"
                          title="View Details"
                        >
                          👁️ View
                        </button>
                        <a
                          ...
                          className="rounded-xl border-2 border-green-200 px-4 py-2 text-xs font-extrabold text-green-700 hover:bg-green-50 hover:border-green-300 transition-all duration-300 hover:scale-105"
                          title="Send Email"
                        >
                          📧 Email
                        </a>
                        <select
                          ...
                          className="rounded-xl border-2 border-slate-300 px-3 py-2 text-xs font-normal focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all duration-300"
                        >
